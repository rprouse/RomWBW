...
accordance with the intentions of their creators.
...
1.  Operating System Frameworks
    ...
    intellectual property successors under modern, permissive
    open-source frameworks (such as the 3-Clause BSD License). All
    custom HBIOS and integration code written explicitly for the RomWBW
    ecosystem is distributed freely under open-source terms.
...
2.  Supplemental Testing & Validation Binary Targets
    ...
    - Engineering Intent: These legacy binaries are packaged strictly as
      an educational and engineering convenience. They serve as
      objective baseline workloads to validate hardware instruction
      sets, benchmark Z80/Z180/Z280 CPU execution, profile serial
      terminal emulation timings, and verify stable disk controller
      storage read/write routines.
...
3.  Notice to Verified Intellectual Property Rights Holders
    ...
    representative of a legacy utility bundled within these testing
    images and object to its inclusion as a historical hardware
    validation target, please contact the repository maintainer directly
    via GitHub Issue or wwarthen@gmail.com. Upon verification of
    ownership, any requested assets will be promptly modified,
