...
;
CPUOSC		.SET	22000000	; CPU OSC FREQ IN HZ
...
SDMODE		.SET	SDMODE_K80W	; SD: DRIVER MODE: SDMODE_[JUHA|N8|CSIO|PPI|UART|DSD|MK4|SC|MT|USR|ZPIO|GPIO|Z80R|EPITX|FZ80|GM|EZ512|K80W]
;
