...
;
PLATFORM	.SET	PLT_NONE	; PLT_[SBC|ZETA|ZETA2|N8|MK4|UNA|RC2014|RCZ80|RCEZ80|RCZ180|EZZ80|SCZ180|GMZ180|DYNO|RCZ280|MBC|RPH|Z80RETRO|SZ180|DUO|HEATH|EPITX|MON|STDZ180|NABU|SZ80|N8PC|MECB]
...
CPUOSC		.SET	1000000		; CPU OSC FREQ IN HZ
...
Z180_RAMLOC	.SET    $80		; Z180: START RAM LOCATION $80 FOR Z180, $40 FOR HD64180
;
...
LCDENABLE	.SET	FALSE		; ENABLE LCD DISPLAY (PARALLEL BUS)
LCDBASE		.SET	$DA		; BASE I/O ADDRESS OF LCD CONTROLLER
LCDI2CENABLE	.SET	FALSE		; ENABLE LCD DISPLAY (I2C PCF8574 BACKPACK, ALTERNATE TO LCDENABLE)
LCDI2CADDR	.SET	$27		; PCF8574 I2C WRITE ADDRESS
...
TMSMODE		.SET	TMSMODE_NONE	; TMS: DRIVER MODE: TMSMODE_[SCG|N8|MSX|MSXKBD|MSXMKY|MBC|COLECO|DUO|NABU|MSXUKY|N8PC|MECB]
...
SDMODE		.SET	SDMODE_NONE	; SD: DRIVER MODE: SDMODE_[JUHA|N8|CSIO|PPI|UART|DSD|MK4|SC|MT|USR|ZPIO|GPIO|Z80R|EPITX|T35|GM|EZ512|K80W]
...
SCSIBASE	.SET	$48		; SCSI: BASE I/O ADDRESS OF 5380
SCSIMODE	.SET	SCSIMODE_LATCH	; SCSI: DRIVER MODE: SCSIMODE_[DIRECT|LATCH]
SCSIPDMA	.SET	FALSE		; SCSI: ENABLE PSEUDO-DMA
