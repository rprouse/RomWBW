...
;
; WBW 2026-3-30: MADE I/O 16-BIT SAFE TO ACCOMMODATE S100 Z180 CPU BOARD
;
; TODO:
...
DS12RTC_RDREG:
	...
	PUSH	BC			; SAVE BC
	LD	B,0			; 16-BIT SAFETY		
	LD	A,C			; REGSITER TO A
	LD	C,DS12RTC_SEL		; SEL PORT TO C
	OUT	(C),A			; SELECT IT
	INC	C			; SWITCH TO DATA PORT
	IN	A,(C)			; GET REG VALUE
	POP	BC			; RESTORE BC
	HB_EI				; RESTORE INTS
	RET				; DONE
;
