...
DS7_RL1:CALL	PCF_READI2C
	...
	DJNZ    DS7_RL1
;
	CALL	PCF_PREPNACK	; PREP NEGATIVE ACK FOR THE 8TH (LAST) BYTE
	CALL	PCF_WAIT_FOR_PIN; WAIT FOR IT -- NOT PCF_READI2C, ITS LRB
	CALL	NZ,PCF_PINERR	; CHECK WOULD MISFIRE ON OUR OWN NACK
	CALL	PCF_GETBYTE	; READ THE FINAL BYTE, NACK ALREADY SENT
	LD	(HL),A
;
#IF (0)
	LD	A,8
...
DS7_WTPIN:
	...
	PUSH	AF		; SAVE RESULT -- PCF_STOP CLOBBERS A
	CALL	PCF_STOP
	POP	AF
	RET
;
