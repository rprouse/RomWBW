...
;
	...
	JR	Z,PCF_WFA_ACK	; BIT CLEAR = ACK RECEIVED
...
PCF_WFBB0:
	IN	A,(PCF_RS1)
	AND	PCF_BB
	JR	NZ,PCF_WFBB_OK	; BB=1 MEANS FREE (SEE COMMENT ABOVE)
	DEC	HL
	LD	A,H
	OR	L
	...
	RET
PCF_WFBB_OK:
	; FLAGS HERE ARE NZ (FROM THE "AND PCF_BB" CHECK THAT GOT US HERE), BUT
