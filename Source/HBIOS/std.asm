...
;
; DRIVER CONFIG BLOCK STANDARD OFFSETS
;
CFG_DISPTBL	.EQU	0		; DRIVER FUNCTION TABLE ADDRESS (WORD)
CFG_DRVTYPE	.EQU	2		; DRIVER TYPE: DISK, CHAR, ETC. (BYTE)
CFG_UNIT	.EQU	3		; HBIOS UNIT NUMBER (I.E., DISK UNIT #1) (BYTE)
CFG_DEVNUM	.EQU	4		; DRIVER DEVICE NUMBER (I.E., UART0:) (BYTE)
CFG_STATUS	.EQU	5		; CURRENT STATUS (SEE ERR_ IN HBIOS.INC) (BYTE)
CFG_TAG		.EQU	6		; DRIVER TAG STRING PTR ("UART$")
;
CFG_DSKADR	.EQU	8		; LBA/CHS FOR DISK DRIVERS (DWORD)
CFG_DSKCAP	.EQU	12		; DISK CAPACITRY FOR DISK DRIVERS (DWORD)
;
CFG_LINEATTR	.EQU	8		; LINE ATTRIBUTES FOR CHAR DRIVERS
;
